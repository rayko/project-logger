...
class TodoItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todo_item" do
    assert_difference("TodoItem.count") do
      post todo_items_url, params: { todo_item: { checked: @todo_item.checked, project_id: @todo_item.project_id, text: @todo_item.text } }
    end
  ...
  test "should update todo_item" do
    patch todo_item_url(@todo_item), params: { todo_item: { checked: @todo_item.checked, project_id: @todo_item.project_id, text: @todo_item.text } }
